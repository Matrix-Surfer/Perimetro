---
title: "Una falla en la integración de IA con GitHub permitía secuestrar repositorios desde un mensaje"
date: "2026-06-04"
...
nivelAtencion: "Medio"
status: "En monitoreo"
resumen: "Una falla en la GitHub Action de Claude Code permitía tomar control de repositorios públicos con solo abrir un issue. Anthropic corrigió la falla. Equipos que usan esta integración deben confirmar que están en la versión actualizada."
...
- Confirmar que la GitHub Action de Claude Code está en su versión más reciente en todos los repositorios que la usan.
- Revisar el historial de ejecuciones del flujo de trabajo en busca de actividad inesperada, especialmente issues abiertos por cuentas desconocidas que hayan disparado automatizaciones.
- Evaluar si los permisos configurados para la acción son los mínimos necesarios para su funcionamiento.
